...
class SystemPrompt(Enum):
    ...
    PROJECT_SYS_ARCHITECTURE_PM = "project_sys_architecture_pm"
    ...
    PROJECT_SYS_MODULES_PM = "project_sys_modules_pm"
    ...
    PROJECT_SYS_DATABASE_PM = "project_sys_database_pm"
    ...
    PROJECT_SYS_API_PM = "project_sys_api_pm"
