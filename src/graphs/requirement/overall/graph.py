...
def create_agent() -> CompiledStateGraph:
    ...
    agent_builder.add_conditional_edges(
        ...
        ["optimize_requirement_overall_tool_node", "review_requirement_overall_node"]
    )
    ...
    agent_builder.add_conditional_edges(
        ...
        routes.review_requirement_overall_aggregator_router,
        ["optimize_requirement_overall_node", "optimize_requirement_overall_issue_node"]
    )

    agent_builder.add_conditional_edges(
        "optimize_requirement_overall_issue_node",
        routes.optimize_requirement_overall_issue_tool_router,
        ["optimize_requirement_overall_issue_tool_node", END]
    )
    agent_builder.add_edge("optimize_requirement_overall_issue_tool_node", "optimize_requirement_overall_issue_node")
