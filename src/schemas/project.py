...
class ProjectDetailResponse(BaseModel):
    ...
    description: Optional[str] = Field(None, description="项目描述")
    requirement_outline_design: Optional[str] = Field(None, description="需求大纲设计内容")
    requirement_module_design: Optional[str] = Field(None, description="需求模块设计内容")
    requirement_overall_design: Optional[str] = Field(None, description="需求设计内容")
    architecture_design: Optional[str] = Field(None, description="架构设计内容")
    database_design: Optional[str] = Field(None, description="数据库设计内容")
