...
class ConversationSummaryService:
    ...
    def __init__(self):
        self.repository = conversation_summary_repository

    async def get_conversation_summary_to_str(self, project_id: str, limit: int = 20) -> str:
        """提取项目会话摘转为字符串"""
        summaries = await self.repository.list_by_project(project_id, limit)
