...
class ProjectFileService:
    ...
    def __init__(self):
        self.repository = project_file_repository

    async def format_project_files_summary_to_str(self, project_id: str) -> str:
        """提取项目文件摘要转为字符串
        ...
        """
        content = ""
        project_files = await self.repository.list_by_project(project_id)
